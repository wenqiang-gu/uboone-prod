...
echo "now working in $wc_workdir"
...
# else
# 	echo "Bad: nusel $nevts1, port $nevts2, stm $nevts3, input $wc_eventcount" | tee -a ../wirecell.log
...
# mv merge.root $wc_workdir
# mv nue_*.root $wc_workdir
# 
cd $wc_workdir
